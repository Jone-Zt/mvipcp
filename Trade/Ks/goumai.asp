...
<script src="../JS/JsKs/cart.js?<%=time()%>"></script>
<script src="../JS/20141212.js"></script>
<script src="../JS/PassTime.js" type="text/javascript"></script>
</head><body onLoad="javascript:jisuan();">
<div class="wrap">
  <div class="head"><h2 id="navtit">投注-<em id="jianga"></em></h2><a href="" class="btn-qgkj" id="sourceUrl"><span><em></em></span>继续选号</a></div>
  <div class="w320">
    <div class="area1">
      <div class="xq-tit" endtime="1440035220" prevtime="80" issale="0" pt="HSZ">
        <h2>第 <cite id="showid" class="red"></cite> 期选号内容</h2>
        <em class="red" id="showtime"></em></div>
      <div class="buy-box">
        <ul id="mycart"></ul>
        <p id="tools"><a href="javascript:jisuan();" class="btn2 red" act="rnd1">机选1注</a><a href="javascript:jisuan();" class="btn2 red" act="rnd5">机选5注</a><a href="javascript:jisuan();" class="btn2" act="delall">全部删除</a></p>
      </div>
    </div>
    <div class="line-3"></div>
    <div class="area1">
      <div class="xq-nav"><a href="javascript:;" class="on" buy="0" id="k1">投注</a><a href="javascript:;" buy="2" id="k2">合玩</a><a href="javascript:;" buy="1" id="k3">追号</a></div>
      <div class="infolist">
        <table width="100%">
          <tbody><tr>
            <th>投注倍数:</th>
            <td><input name="bei" id="ownMul" type="tel" max="9999" maxlength="4" class="ipt-6" value="1">
              &nbsp;&nbsp;倍</td>
          </tr>
          <tr>
            <th>投注注数:</th>
      ...
      <div class="infolist none">
        <table width="100%">
          <tbody>
            <tr>
              <th>投注倍数</th>
              <td><input name="bei" type="tel" class="ipt-6" id="apMul" max="9999" maxlength="4" value="1">
                &nbsp;&nbsp;倍</td>
            </tr>
            <tr>
              <th>追号期数</th>
              <td><input name="qi" type="tel" maxlength="5" id="apNum" max="120" value="10" class="ipt-6">
                &nbsp;&nbsp;期</td>
            </tr>
            <tr>
              <th>投注<%=setting(56)%></th>
              <td><strong class="red" id="apMoney">0</strong><%=setting(56)%></td>
            </tr>
            <tr>
              <td colspan="2"><input type="checkbox" class="check-1" id="stopbuy" checked="checked">
                方案中奖后自动停止追号 </td>
            </tr>
          </tbody>
        </table>
      ...
      <table width="100%">
        ...
        <tr>
          <th>方案<%=setting(56)%></th>
          <td><strong class="red" id="coopCount"><script>if(localStorage["storage258001mul"])document.write(localStorage["storage258001mul"]);else document.write(0);</script>
        ...
        <tr>
          <th>我要投注</th>
          <td><input type="tel" onBlur="javascript:tjisuan();" class="ipt-6" id="meRG" autocomplete="off" value="0" maxlength="7"><%=setting(56)%> <cite style="font-size:12px;">发起人至少投注5%</cite></td>
        </tr>
        <tr>
          <th>我要保底</th>
          <td><input type="tel" onBlur="javascript:tjisuan1();" class="ipt-6" id="meBD" autocomplete="off" value="0" maxlength="7"><%=setting(56)%> <em id="baodibl"></em> <cite style="font-size:12px;">最多可保底<strong id="maxBD" class="red">1</strong><%=setting(56)%></cite></td>
        </tr>
        <tr>
          <th>是否公开</th>
        ...
        <tr>
          <th>您需支付</th>
          <td class="mycoop"><strong class="red" id="tsum">0</strong><%=setting(56)%>(投注<strong class="red" id="trengou">0</strong><%=setting(56)%>+保底<strong class="red" id="tbaodi">0</strong><%=setting(56)%>)</td>
        </tr>
      </tbody></table>
    </div> 
  ...
  <div class="foot-tit">
             <%
	ttgeturl = Request.ServerVariables("PATH_INFO") &"?"&request.QueryString
  if session("un") <> "" then
