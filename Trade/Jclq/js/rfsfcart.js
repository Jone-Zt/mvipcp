(function(e) {
    ...
    n.mobile.playType = "RSF",
    n.mobile.buyPercent = "1",
    ...
    n.mobile.codeViewInit = function() {
        ...
        for (var o = 0; o < r.length; o++) {
            ...
            h > 0 ? h = "<b class='red'>(" + h + ")</b>": h = "<b class='green'>(" + h + ")</b>",
            i.push("<tr id='match-" + r[o] + "' matchcode='" + r[o] + "' homeTeam='" + u.homeTeam + "' awayTeam='" + u.awayTeam + "' endtime='" + u.endtime + "' rq='" + u.lose + "'>"),
            i.push("<th width='10%'></th>"),
            i.push("<th width='80%'><ul class='list-hd'><li>" + u.awayTeam + "</li><li class='vs'><em class='gray'>VS</em></li><li>" + u.homeTeam + h + "</li></ul></th>"),
            i.push("<th width='10%'></th></tr>"),
            i.push("<tr id='bet-" + r[o] + "' matchcode='" + r[o] + "' homeTeam='" + u.homeTeam + "' awayTeam='" + u.awayTeam + "' endtime='" + u.endtime + "' rq='" + u.lose + "'>"),
    ...
    n.mobile.codeConfInit = function() {
        ...
        v.on(n.lottery.tap,
        function() {
            e.location.href = "/Trade/jclq/rfsf.html"
        }),
        m.on("click",
        function() {
        ...
        function() {
            ...
            i = parseInt(r * 100),
            s = t("#percent");
            i > 5 ? (n.mobile.buyPercent = r, s.text(i)) : (n.mobile.buyPercent = "1", s.text(5)),
    ...
    n.mobile.submitInit = function() {
        t("#pay_buy").on({
            click: function() {
                ...
                !1;
                //n.mobile.postData()
				football_submit("storage_130043_rfsf_map","storage_130043_rfsf_game");
            },
            touchstart: function() {
    ...
    t(function() {
        n.mobile.storageGameMap = "storage_130043_rfsf_map",
        n.mobile.storageGame = "storage_130043_rfsf_game",
