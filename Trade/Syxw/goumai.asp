...
<script src="../JS/Syxw/cart.js?v=0721"></script>
<script src="../JS/20141212.js"></script>
<script src="../JS/PassTime.js?v=0.0.1"></script>
</head><body onLoad="javascript:jisuan();">
<div class="wrap">
  <div class="head"><h2 id="navtit">投注<em id="jiangc"></em></h2><a href="./index.asp" class="btn-qgkj" id="sourceUrl"><span><em></em></span>继续选号</a></div>
  <div class="w320">
    <div class="area1">
      <div class="xq-tit" endtime="1438758600" prevtime="480" issale="0" pt="r3">
    ...
    <div class="area1">
      <div class="xq-nav"><a href="javascript:;" class="on" buy="0">投注</a><a href="javascript:;" buy="2">合玩</a><a href="javascript:;" buy="1">追号</a></div>
      <div class="infolist" id="k1">
        <table width="100%">
          <tbody><tr>
            <th>投注倍数:</th>
            <td><input name="bei" id="ownMul" type="tel" max="100000" maxlength="5" class="ipt-6" value="1">&nbsp;&nbsp;倍</td>
          </tr>
          <tr>
            <th>投注注数:</th>
          ...
          <tr>
            <th>投注<%=setting(56)%>:</th>
            <td><strong class="red" id="ownMoney">2</strong><%=setting(56)%></td>
          </tr>
        </tbody></table>
      </div>
      <div class="infolist none" id="k2">
        <table width="100%">
          <tbody>
            <tr>
              <th>投注倍数</th>
              <td><input name="bei" type="tel" class="ipt-6" id="apMul" max="100000" maxlength="5" value="1">&nbsp;&nbsp;倍</td>
            </tr>
            <tr>
              <th>追号期数</th>
              <td><input name="qi" type="tel" maxlength="5" id="apNum" max="120" value="10" class="ipt-6">&nbsp;&nbsp;期
              </td>
            </tr>
            <tr>
              <th>投注<%=setting(56)%></th>
              <td><strong class="red" id="apMoney">20</strong><%=setting(56)%></td>
            </tr>
            <tr>
          ...
          <div class="infolist infolist3 none" id="k3">
 <table width="100%">
        <tbody><tr>
          <th>投注倍数</th>
        ...
        <tr>
          <th>我要分为</th>
          <td><input type="tel" onKeyUp="javascript:tjisuan();" onBlur="javascript:meFWabcd();" class="ipt-6" id="meFW" autocomplete="off" value="0" maxlength="7">份 <cite style="font-size:12px;">每份 <span class="red" id="meFWab">1</span> <%=setting(56)%></cite></td>
        </tr>
        <tr>
          <th>我要投注</th>
          <td><input type="tel" onBlur="javascript:tjisuan();" class="ipt-6" id="meRG" autocomplete="off" value="0" maxlength="7">份 <cite style="font-size:12px;">发起人至少投注5%</cite></td>
        </tr>
        <tr>
          <th>我要保底</th>
          <td><input type="tel" onBlur="javascript:tjisuan1();" class="ipt-6" id="meBD" autocomplete="off" value="0" maxlength="7">份 <em id="baodibl"></em> <cite style="font-size:12px;">最多可保底<strong id="maxBD" class="red">1</strong>份</cite></td>
        </tr>
        <tr>
          <th>是否公开</th>
