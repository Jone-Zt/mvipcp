...
Date.prototype.Format = function (fmt) { //author: meizz 
    ...
    return fmt;
                ...
                var buyInsert = {
                    ...
                    value:[[Session('un'),o.e,o.c,o.a,o.d,Total-lostMoney,into.TC,into.BD,ishm,"0","1",overtimeorderid.Format("yyyy-MM-dd hh:mm:ss"),data.tp,SPPlan]]
                }
                if(ishm=="1") {
                ...
                if(ishm=="1"){
                    ...
                    if(into.BD>0) bankInsert.value.push([NewId,"0",Session("un"),"竞彩足球","竞彩足球"+typeToStr[data.tp],into.BD,Total,"1",Total,into.BD,"保底冻结",into.BD,UserMoney,UserMoney-lostMoney,"未处理","0","保底冻结"]);
                }
