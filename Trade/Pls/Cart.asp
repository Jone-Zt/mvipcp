...
<script src="../JS/Pls/cart.js"></script>
<script src="../JS/20141212.js"></script>
<script src="../JS/PassTime.js?v=0.0.1"></script>
</head><body>
<div class="head"><h2 id="navtit">投注排列三</h2><a href="./index.asp" class="btn-qgkj" id="sourceUrl"><span><em></em></span>继续选号</a></div>
<div class="w320">
  <div class="area1">
    <div class="xq-tit" pt="Z1" issue="2015210" issale="0" endtime="1438774200">
      <h2>第 <cite id="showid" class="red"></cite> 期选号内容</h2>
      <em class="red" id="showtime"></em> </div>
    <div class="buy-box">
      <ul id="mycart"><li pt="Z1" code="9,9,9" count="1"><a href="javascript:;" class="cp-cls">X</a>直选：<strong class="red">9,9,9</strong></li></ul>
  ...
  <div class="area1">
    ...
    <div class="infolist">
      <table width="100%">
        <tbody><tr>
          <th>投注倍数</th>
          <td><input type="tel" id="ownMul" class="ipt-6" max="200" maxlength="5" value="1">倍</td>
        </tr>
        <tr>
          <th>投注注数</th>
    ...
    <div class="infolist none">
      <table width="100%">
        <tbody><tr>
          <th>投注倍数</th>
          <td><input type="tel" class="ipt-6" max="200" maxlength="5" id="coopMul" value="1">倍</td>
        </tr>
        <tr>
          <th>方案<%=setting(56)%></th>
          <td><strong class="red" id="coopCount">1</strong> 注，<strong class="red" id="coopMoney">2</strong> <%=setting(56)%></td>
        </tr>
        <tr>
          <th>盈利提成</th>
          <td>
          	<select class="sel-7" id="royalty" name="royalty " autocomplete="off">
        ...
        <tr>
          <th>是否公开</th>
          <td>
            <select class="sel-zj" name="ispublic" id="ispublic" autocomplete="off">
        ...
        <tr>
            <th>方案标题</th>
            <td><input type="text" id="title" autocomplete="off" maxlength="30" class="ipt-c" value="排列三第{issue}期"></td>
          </tr>
          <tr>
            <th>合玩宣言</th>
        ...
        <tr>
          <th>您需支付</th>
          <td class="mycoop"><strong class="red" id="price">1</strong> <%=setting(56)%>(投注 <strong class="red" id="buyprice">1</strong> <%=setting(56)%>+保底 <strong class="red" id="baoprice">0</strong> <%=setting(56)%>)</td>
        </tr>
      </tbody></table>
    </div>
    <div class="infolist none">
      <table width="100%">
        <tbody><tr>
          <th>投注倍数</th>
          <td><input class="ipt-6" id="apMul" type="tel" max="200" maxlength="5" value="1">倍</td>
        </tr>
        <tr>
          <th>追号期数</th>
        ...
        <tr>
          <td colspan="2"><input type="checkbox" class="check-1" id="stopbuy">
            中奖后停止追号
