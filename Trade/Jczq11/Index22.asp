...
<html><head><title>合玩大厅-<%=Setting(0)%></title>
...
<script src="/JS/tthm.js"></script>
 <div class="head"><h2 onClick="javascript:upcss();" id="navtit"><em id="jiangaa"></em><span id="jiange" class="head-arr"><em></em></span></h2><a href="../../index.asp" class="btn-qgkj" id="sourceUrl"><span><em></em></span>游戏大厅</a></div>
  <div class="pop-box2 none" id="jiangf">
    ...
    <div class="filt-popc">
      <ul>
	    <li><a href="javascript:cx(100);" class="btn-pop btn-pop-on plays" id="tstyle100" >全部游戏</a></li>
        ...
        <li><a href="javascript:cx(44);" class="btn-pop plays" id="tstyle44" >竟彩足球</a></li><%end if%><%if LotterySetting(45)="1" then%>
        <li><a href="javascript:cx(45);" class="btn-pop plays" id="tstyle45" >竟彩篮球</a></li><%end if%><%if LotterySetting(46)="1" then%>
        <li><a href="javascript:cx(46);" class="btn-pop plays" id="tstyle46" >北京单场</a></li><%end if%><%if LotterySetting(0)="1" then%>
        <li><a href="javascript:cx(0);" class="btn-pop plays" id="tstyle0" >重庆时时彩</a></li><%end if%><%if LotterySetting(1)="1" then%>
...
<div align="center" style="margin:8px 0 0 0 ;overflow:hidden">
	...
	<label class="label">
         <select class="ttselect" onChange="javascript:cx1('jia');">
          <option value="">此游戏所有合玩</option>
         <option value="1">今天全部合玩</option>
         <option value="3">最近3天的合玩</option>
         <option value="70">最近7天的合玩</option> 
        </select>
