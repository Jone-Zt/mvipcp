...
<script src="../JS/Swxw/cart.js"></script>
<script src="../JS/20141212.js"></script>
<script src="../JS/PassTime.js?v=0.0.1"></script>
</head><body>
<div class="head"><h2 id="navtit">投注15选5</h2><a href="./index.asp" class="btn-qgkj" id="sourceUrl"><span><em></em></span>继续选号</a></div>
<div class="w320">
  <div class="area1">
    <div class="xq-tit" issue="2015236" issale="0" endtime="1441017600">
  ...
  <div class="area1">
    ...
    <div class="infolist">
      <table width="100%">
        <tbody><tr>
          <th>投注倍数</th>
          <td><input type="tel" id="ownMul" class="ipt-6" max="99" maxlength="5" value="1">
            倍</td>
        </tr>
        <tr>
          <th>投注注数</th>
    ...
    <div class="infolist none">
      <table width="100%">
        <tbody><tr>
          <th>投注倍数</th>
          <td><input type="tel" class="ipt-6" max="99" maxlength="5" id="coopMul" value="1">
            倍</td>
        </tr>
        <tr>
          <th>方案<%=setting(56)%></th>
        ...
        <tr>
          <th>我要投注</th>
          <td><input type="tel" class="ipt-6" id="meRG" autocomplete="off" value="0" maxlength="7">
            <%=setting(56)%> <cite class="font12">至少投注5%</cite></td>
        </tr>
        <tr>
          <th>我要保底</th>
          <td><input type="tel" class="ipt-6" id="meBD" autocomplete="off" value="0" maxlength="7">
            <%=setting(56)%> <em id="baodibl"></em><cite class="font12">最多可保底<strong id="maxBD" class="red">0</strong><%=setting(56)%></cite></td>
        </tr>
        <tr>
          <th>是否公开</th>
        ...
        <tr>
          <th>方案标题</th>
          <td><input type="text" id="title" autocomplete="off" maxlength="30" class="ipt-c" value="七乐彩第{issue}期"></td>
        </tr>
        <tr>
          <th>合玩宣言</th>
    ...
    <div class="infolist none">
      <table width="100%">
        <tbody><tr>
          <th>投注倍数</th>
          <td><input class="ipt-6" id="apMul" type="tel" max="99" maxlength="5" value="1">
            倍</td>
        </tr>
        <tr>
          <th>追号期数</th>
          <td><input name="qi" type="tel" maxlength="5" id="apNum" max="50" value="10" class="ipt-6">
            期</td>
        </tr>
        <tr>
          <th>投注<%=setting(56)%></th>
