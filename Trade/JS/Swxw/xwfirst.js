var caizhong="\u0031\u0035\u9009\u0035",kaijiang="Swxw",qihaoid="qlchistory",gp=0;
(function(e) {
    var t = e.$,
    n = e.kureicp;
    ...
    n.mobile.selectCodeInit = function() {
        ...
        function() {
            ...
            n = "btn-numon",
            r = "none";
            e.hasClass(n) ? (e.removeClass(n), v.addClass(r)) : (e.addClass(n), v.removeClass(r))
        }),
        m.on(n.lottery.tap, "a",
        function() {
            var e = t(this),
            r = e.text() * 1,
            i = "selected",
            ...
            function(e, n) {
                ...
                s = t(this);
                t.inArray(r, f) != -1 ? s.addClass(i) : s.removeClass(i)
            }),
            n.mobile.count()
        }),
        ...
        p.on({
            click: function() {
                ...
                i = t(".pick").eq(n.mobile.LOT_METHOD).find("ul"); ! r || i.find(".selected").length > 0 || n.mobile.LOT_METHOD === 1 ? n.mobile.pickBall(t(this)) : e.location.href = "./cart.asp"
            },
            touchstart: function() {
    ...
    n.mobile.pickBall = function(r) {
        ...
        a == "addcart" ? (t("#group").text(n.mobile.cart.group), n.mobile.clearAll()) : e.location.href = "./cart.asp"
    },
    ...
    n.mobile.AsynDownData = function() {
        ...
        o = t("#countdowm"),
        u = t("#qlchistory");
        i.html('15\u90095-<cite id="game">\u81ea\u9009</cite><span class="head-arr"><em></em></span>');
        ...
        function(e) {
            if (e) {
                ...
                t.each(a,
                function(e, t) {
                    var n = t.number.split(/\+/g),
                    r = n[1] ? ' + <strong class="blue">' + n[1] + "</strong>": "";
                    f.push("<p>\u7b2c" + t.issue + '\u671f\u5f00\u5956\uff1a<strong class="red">' + n[0] + "</strong>" + r + "</p>")
                }),
                u.html(f.join(""))
            }
        })
