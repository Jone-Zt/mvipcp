...
function panduan()
{
	...
	zhusu=localStorage["storage223515mul"],wanfa1="\u0031\u0035\u9009\u0035",qihao3=qihao,tqihaosum=qihao,wfname="",wfname1="",kcode="";
					if(tk1=="on")//获取投注
					{
					...
					else if(tk3=="on")//获取追号
					{
							...
							var tjurl="../Include/Ajax_ZG_D.asp",qisu2=beisu;for(var i=1;i<qisu;i++) qisu2=qisu2+","+beisu;
							var b=Number(qihao);
							for(var i=1;i<qisu;i++)
							{
								b++;
								tqihaosum=tqihaosum+","+b;
							}
					...
					else   //获取合玩
					{
						...
						tjurl="/Trade/Include/Ajax_HM_D.asp",zhifu=$("#tsum").html();sum=$("#coopMoney").html();
					}
					if(localStorage["storage223515"]&&localStorage["storage223515mul"])
					{
						var k1=localStorage["storage223515"].split(";"),codes="";
						for(var i=0;i<k1.length;i++)
						{
							...
							{	
								...
								{
									var k3=k2[j].split(" ");
									if(k3.length>5){wanfa="[101]";wfname="\u590d\u5f0f";}else{wanfa="[102]";wfname="\u5355\u5f0f"}
									if(kcode!="") kcode=kcode+"$"+k3;else kcode=kcode+k3;
								}
							}
					...
					$.ajax({
								...
								data:{
									...
									baodiCount:baodi,
									tc_money:ticheng, 
									escstr:localStorage["storage223515"],  								
								},
							success:function(data)
							{
								...
								{
									alert("\u6295\u6ce8\u6210\u529f\uff01");
						if(localStorage["storage223515"]&&localStorage["storage223515mul"]){localStorage.removeItem("storage223515");localStorage.removeItem("storage223515mul");}
...
(function(e) {
    var t = e.$,
    n = e.kureicp;
    n.mobile.lotType = n.lottery.lotType.xw,
    ...
    n.mobile.codeConfInit = function() {
        ...
        function() {
            ...
            e.remove(),
            n.mobile.count("bd"),
            o.find("li").length || o.html('<li class="nocode"> \u60a8\u8fd8\u6ca1\u6709\u9009\u62e9\u4efb\u4f55\u53f7\u7801\uff01</li>')
        }),
        ...
        t("#title,#content").on({
            focus: function() {
                ...
                r = t.trim(e.val()),
                i = e.attr("id"),
                s = i == "title" ? "15\u90095\u7b2c" + n.mobile.issue + "\u671f": "\u8fd9\u4e2a\u5bb6\u4f19\u5f88\u61d2\uff0c\u53ea\u60f3\u4e2d\u5927\u5956";
                r == s && e.val("")
            },
            blur: function() {
                var e = t(this),
    ...
    n.mobile.AsynDownData = function() {
        ...
        function(e) {
            ...
            }), i.text(t.trim(e.issue)), n.mobile.countDownInit(), n.mobile.issue = e.issue, s.html("\u622a\u6b62\u65f6\u95f4\uff1a" + e.etstr), o.val("15\u90095\u7b2c{issue}\u671f".replace(/{issue}/i, n.mobile.issue)), n.string.getUrlParam("dest") && n.mobile.Callbacks())
        })
    },
	...
	var tk1=document.getElementById("k1").className,tk2=document.getElementById("k2").className,tk3=document.getElementById("k3").className,qihao=$("#showid").html(),
	zhusu=localStorage["storage223515mul"],wanfa1="\u0031\u0035\u9009\u0035",qihao3=qihao,tqihaosum=qihao;
					...
					else   //获取合玩
					{
						...
						$("#meRG").val(ttrengou);
						$("#trengou").html(ttrengou);var ticheng=document.getElementById("royalty").value,
						tjurl="/Trade/Include/Ajax_HM_D.asp",zhifu=$("#tsum").html();
					}
					if(localStorage["storage223515"]&&localStorage["storage223515mul"])
					{
						var k1=localStorage["storage223515"].split(";"),kcode=codes="";
						for(var i=0;i<k1.length;i++)
						{
							var k2=k1[i].split("|");
							for(var j=0;j<k2.length;j++)
							{	
								if(j==1)
								{
									var k3=k2[j].split(" ");
									if(k3.length>5){wanfa="[101]";wfname="\u590d\u5f0f";}else{wanfa="[102]";wfname="\u5355\u5f0f"}
									if(kcode!="") kcode=kcode+"$"+"["+wfname+"]"+k3;else kcode=kcode+"["+wfname+"]"+k3;
								}
							}
						}
