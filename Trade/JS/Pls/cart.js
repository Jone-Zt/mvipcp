...
function panduan()
{
	var tk1=document.getElementById("k1").className,tk2=document.getElementById("k2").className,tk3=document.getElementById("k3").className,qihao=$("#showid").html(),
		zhusu=localStorage["storage110033mul"],wanfa1="\u6392\u5217\u4e09",tqihao2=qihao,wfname="",wfname1="";
			if(tk1=="on")  //投注
			{
			...
			if(localStorage["storage110033"]&&localStorage["storage110033mul"])
					{
						var k1=localStorage['storage110033'].split(";"),codes="";
			...
			$.ajax({
							...
							data:{
								...
								baodiCount:baodi,
								tc_money:ticheng, 
								escstr:localStorage["storage110033"],                    
							},
							success:function(data)
							{
								...
								{
									alert("\u6295\u6ce8\u6210\u529f\uff01");
							if(localStorage["storage110033"]&&localStorage["storage110033mul"]){localStorage.removeItem("storage110033");localStorage.removeItem("storage110033mul");}
...
(function(e) {
    ...
    n.mobile.codeViewInit = function() {
        ...
        if (i) {
            for (var f = 0; f < u; f++) {
                ...
                h = l[1],
                p = l[0];
                o.push("<li pt=" + p + " code=" + c + " count=" + h + '><a href="javascript:;" class="cp-cls">X</a>' + n.mobile.title[p] + '\uff1a<strong class="red">' + c + "</strong></li>")
            }
            a.html(o.join(""))
    ...
    n.mobile.codeConfInit = function() {
        ...
        function() {
            ...
            o,
            u = t("#mycart");
            o = (n.localstorage.getItem(n.mobile.storageName) + ";").replace(s + "|" + i + "|" + r + ";", "").replace(/^;|;$/g, ""),
            n.localstorage.setItem(n.mobile.storageName, o),
            n.localstorage.setItem(n.mobile.storageMulName, n.localstorage.getItem(n.mobile.storageMulName) - i),
            e.remove(),
            n.mobile.count(),
            u.find("li").length === 0 && u.html('<li class="nocode">\u60a8\u8fd8\u6ca1\u6709\u9009\u62e9\u4efb\u4f55\u53f7\u7801\uff01</li>')
        }),
        ...
        function() {
            ...
            c,
            h = 1,
            p = '<li pt="{pt}" code="{code}" count="{count}"><a href="javascript:;" class="cp-cls">X</a>{name}\uff1a<strong class="red">{red}</strong></li>';
            if (/rnd\d{1}/.test(e)) {
                ...
                for (var d = 0; d < r; d++) {
                    ...
                    case "Z1":
                        ...
                        break;
                    case "F3":
                        var v = n.number.eachCombo(n.number.random({
                            min: 0,
                            max: 9,
                            size: 2,
                            repeat: 0,
                    ...
                    f = o + "|" + h + "|" + c,
                    l += p.replace("{pt}", o).replace("{code}", c).replace("{count}", h).replace("{name}", n.mobile.title[o]).replace("{red}", c),
        ...
        t("#title,#content").on({
            focus: function() {
                ...
                r = t.trim(e.val()),
                i = e.attr("id"),
                s = i == "title" ? "\u6392\u5217\u4e09\u7b2c" + n.mobile.issue + "\u671f": "\u8fd9\u4e2a\u5bb6\u4f19\u5f88\u61d2\uff0c\u53ea\u60f3\u4e2d\u5927\u5956";
                r == s && e.val("")
            },
            blur: function() {
                var e = t(this),
    ...
    n.mobile.AsynDownData = function() {
        var e, r = t("#title");
        t.getJSON("#" + Math.random(),///int/p3cart/?rnd=
        function(e) {
            t(".xq-tit").attr({
                issue: e.issue,
                issale: e.IsOpen,
            ...
            r.val("\u6392\u5217\u4e09\u7b2c{issue}\u671f".replace(/{issue}/i, n.mobile.issue)),
    ...
    n.mobile.postData = function() {
		...
		var tk1=document.getElementById("k1").className,tk2=document.getElementById("k2").className,tk3=document.getElementById("k3").className,qihao=$("#showid").html(),
		zhusu=localStorage["storage110033mul"],wanfa1="\u6392\u5217\u4e09",tqihao2=qihao;
			if(tk1=="on")  //投注
			{
				var beisu=document.getElementById("ownMul").value,sum=document.getElementById("ownMoney").innerHTML,tjurl="../Include/Ajax_ZG_D.asp";
			}
        ...
        if (e == 0) {
            ...
            o = {
                ...
                SponsorBuy: h,
                SponsorDeduck: p,
                PTitle: t.trim(t("#title").val()) || "\u6392\u5217\u4e09\u7b2c" + n.mobile.issue + "\u671f",
