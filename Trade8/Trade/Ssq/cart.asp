...
<script src="../JS/Ssq/cart.js"></script>
<script src="../JS/20141212.js"></script>
<script src="../JS/PassTime.js?v=0.0.1"></script>
</head><body>
<div class="wrap">
  <div class="head"><h2>投注双色球</h2><span class="btn-qgkj" id="reffer"><span><em></em></span>返回</span></div>
  <div class="w320">
    <div class="area1">
      <ul id="bet-tools" issue="2015102" issale="0" endtime="1441108500">
        <li><span class="btn2" do="add"><i class="ico-add"></i> 手动添加</span></li>
        <li><span class="btn2" do="rnd"><i class="ico-pick2"></i> 机选1注</span></li>
        <li><span class="btn2" do="clear"><i class="ico-del2"></i> 全部删除</span></li>
      </ul>
      <div class="buy-box">
        <ul id="mycart"></ul>
      </div>
    ...
    <div class="area1">
      ...
      <div class="infolist none">
        <table width="100%">
          ...
          <tr>
            <th>我要投注</th>
            <td><input type="tel" class="ipt-6" id="meRG" autocomplete="off" value="0" maxlength="7"><cite class="font12">至少投注5%</cite></td>
          </tr>
          <tr>
            <th>我要保底</th>
            <td><input type="tel" class="ipt-6" id="meBD" autocomplete="off" value="0" maxlength="7"><em id="baodibl"></em><cite class="font12">最多可保底<strong id="maxBD" class="red">0</strong><%=setting(56)%></cite></td>
          </tr>
          <tr>
            <th>是否公开</th>
          ...
          <tr>
            <th>方案标题</th>
            <td><input type="text" id="title" autocomplete="off" maxlength="30" class="ipt-c" value="双色球第{issue}期"></td>
          </tr>
          <tr>
            <th>合玩宣言</th>
      ...
      <!--追号[[-->
      <button type="button" class="btn btn100" id="pay_buy">立即投注</button>
      <div class="pact"><input type="checkbox" checked="checked" class="check-1" name="agree" id="agree" checked="false">我已阅读并同意<a href="../Include/weituo.asp" class="blue">《用户投注协议》</a></div>    </div>
  </div>
  <div class="foot-tit">
      <%
