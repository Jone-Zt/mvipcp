...
cpztjd = schedule
if request("baodiCount")<>"0" and request("baodiCount")<>"" then
hnumberbd=hnumber+request("baodiCount")
...
'zhushusum=0
zhushusum=getzs_run(codes,ltype)
...
%><err type="0" /><%
elseif tmf-2<>0 or tje-request("allmoney")<>0 OR int(IsBuyMoney)<1 then
%><err type="5" /><% else
