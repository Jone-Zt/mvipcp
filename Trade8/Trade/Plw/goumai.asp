...
<script src="../JS/Plw/cart.js"></script>
<script src="../JS/20141212.js"></script>
<script src="../JS/PassTime.js?v=0.0.1"></script>
</head><body>
<div class="head"><h2 id="navtit">投注排列五</h2><a href="./index.asp" class="btn-qgkj" id="sourceUrl"><span><em></em></span>继续选号</a></div>
<div class="w320">
  <div class="area1">
    <div class="xq-tit" issue="2015210" issale="0" mul="0" endtime="1438774200">
      <h2>第<cite id="showid" class="red"></cite>期选号内容</h2><em class="red" id="showtime"></em>
    </div>
    <div class="buy-box">
      <ul id="mycart"></ul>
      <p><a href="javascript:;" class="btn2 red navBar" num="1">机选1注</a><a href="javascript:;" class="btn2 red navBar" num="5">机选5注</a><a href="javascript:;" class="btn2 navBar" num="0">全部删除</a> </p>
    </div>
  </div>
  ...
  <div class="area1">
    ...
    <div class="infolist none" id="k2">
      <table width="100%">
        ...
        <tr>
          <th>我要投注</th>
          <td><input type="tel" class="ipt-6" id="meRG" autocomplete="off" value="0" maxlength="7"><%=setting(56)%> <cite class="font12">发起人至少投注5%</cite></td>
        </tr>
        <tr>
          <th>我要保底</th>
        ...
        <tr>
            <th>方案标题</th>
            <td><input type="text" id="title" autocomplete="off" maxlength="30" class="ipt-c" value="排列五第{issue}期"></td>
          </tr>
          <tr>
            <th>合玩宣言</th>
        ...
        <tr>
          <th>您需支付</th>
          <td class="mycoop"><strong class="red" id="price">1</strong> <%=setting(56)%>(投注<strong class="red" id="trengou">1</strong> <%=setting(56)%>+保底<strong class="red" id="tbaodi">0</strong> <%=setting(56)%>)</td>
        </tr>
      </tbody></table>
    </div>
      ...
      <table width="100%">
        ...
        <tr>
          <td colspan="2"><input type="checkbox" class="check-1" id="stopbuy" checked="checked">
            中奖后停止追号
            <input type="tel" class="ipt-6 none" id="stopbuyMoney" value="0"></td>
        </tr>
      </tbody></table>
    </div>
