...
<script src="../JS/Sd/cart.js"></script>
<script src="../JS/20141212.js"></script>
<script src="../JS/PassTime.js?v=0.0.1"></script>
</head><body>
<div class="head"><h2 id="navtit">投注福彩3D</h2><a href="./index.asp" class="btn-qgkj" id="sourceUrl"><span><em></em></span>继续选号</a></div>
<div class="w320">
  <div class="area1">
    <div class="xq-tit" pt="Z1" issue="2015236" issale="0" endtime="1441022340">
      <h2>第 <cite id="showid" class="red"></cite> 期选号内容</h2>
      <em class="red" id="showtime"></em> </div>
    <div class="buy-box">
      <ul id="mycart"><li class="nocode">您还没有选择任何号码！</li></ul>
      <p id="tools">
      	 <a href="javascript:;" class="btn2 red" act="rnd1">机选1注</a>
         <a href="javascript:;" class="btn2 red" act="rnd5">机选5注</a>
  ...
  <div class="area1">
    <div class="xq-nav"><a href="javascript:;" class="on" buy="0" id="k1">投注</a><a href="javascript:;" buy="1" id="k2">合玩</a><a href="javascript:;" buy="2" id="k3">追号</a></div>
    <div class="infolist">
      <table width="100%">
        <tbody><tr>
          <th>投注倍数</th>
          <td><input type="tel" id="ownMul" class="ipt-6" max="500" maxlength="5" value="1">
            倍</td>
        </tr>
        <tr>
          <th>投注注数</th>
    ...
    <div class="infolist none">
      <table width="100%">
        <tbody><tr>
          <th>投注倍数</th>
          <td><input type="tel" class="ipt-6" max="500" maxlength="5" id="coopMul" value="1">
            倍</td>
        </tr>
        <tr>
          <th>方案<%=setting(56)%></th>
          <td><strong class="red" id="coopCount">0</strong> 注，<strong class="red" id="coopMoney">0</strong> <%=setting(56)%></td>
        </tr>
        <tr>
          <th>盈利提成</th>
        ...
        <tr>
          <th>我要投注</th>
          <td><input type="tel" class="ipt-6" id="meRG" autocomplete="off" value="0" maxlength="7"><%=setting(56)%> <cite class="font12">至少投注<em id="percent">5</em>%</cite></td>
        </tr>
        <tr>
          <th>我要保底</th>
          <td><input type="tel" class="ipt-6" id="meBD" autocomplete="off" value="0" maxlength="7"><%=setting(56)%> <em id="baodibl"></em><cite class="font12">最多可保底<strong id="maxBD" class="red">0</strong><%=setting(56)%></cite></td>
        </tr>
        <tr>
          <th>是否公开</th>
        ...
        <tr>
            <th>方案标题</th>
            <td><input type="text" id="title" autocomplete="off" maxlength="30" class="ipt-c" value="福彩3D球第{issue}期"></td>
          </tr>
          <tr>
            <th>合玩宣言</th>
        ...
        <tr>
          <th>您需支付</th>
          <td class="mycoop"><strong class="red" id="price">0</strong> <%=setting(56)%>(投注 <strong class="red" id="buyprice">0</strong> <%=setting(56)%>+保底 <strong class="red" id="baoprice">0</strong> <%=setting(56)%>)</td>
        </tr>
      </tbody></table>
    </div>
    <div class="infolist none">
      <table width="100%">
        ...
        <tr>
          <td colspan="2"><input type="checkbox" class="check-1" id="stopbuy" checked="checked">
            中奖后停止追号
            <input type="text" class="ipt-6 none" id="stopbuyMoney" value="0"></td>
        </tr>
      </tbody></table>
    </div>
...
<div class="foot-tit">
  ...
  if session("un") <> "" then
        response.write "<p><a href='../../User/' class='blue'>"&session("un")&"</a><span oclick='javascript:aausername='';'><a href='../../User/logout.asp' class='red'>[退出]</a></span></p>"
	else 
