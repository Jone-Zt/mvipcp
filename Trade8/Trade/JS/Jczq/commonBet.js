					...
					y = {
						...
						goToBuy: function() {
							...
							p.on("click", function() {
								...
								var showvalue = document.querySelector("input[name='show']:checked").value;
								var gdbeishu  = document.querySelector("#qdmin").value;
								t.ajax({
									type:"POST",
