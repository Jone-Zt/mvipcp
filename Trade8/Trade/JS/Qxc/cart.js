...
function panduan()
{
	var tk1=document.getElementById("k1").className,tk2=document.getElementById("k2").className,tk3=document.getElementById("k3").className,qihao=$("#showid").html(),
		zhusu=localStorage["storage110022mul"],wanfa1="\u4e03\u661f\u5f69",tqihao2=qihao,wfname="",wfname1="",kcode="";
		...
		if(localStorage["storage110022"]&&localStorage["storage110022mul"])
		{
			var k1=localStorage["storage110022"].split(";"),codes="";
			for(var i=0;i<k1.length;i++)
			{
				...
				$.ajax({
					...
					data:{
						...
						baodiCount:baodi,
						tc_money:ticheng, 
						escstr:localStorage["storage110022"],     
					},
				success:function(data)
				{
						...
						{
							alert("\u6295\u6ce8\u6210\u529f\uff01");
							if(localStorage["storage110022"]&&localStorage["storage110022mul"]){localStorage.removeItem("storage110022");localStorage.removeItem("storage110022mul");}
...
(function(e) {
    ...
    n.mobile.codeConfInit = function() {
        ...
        t("#title,#content").on({
            focus: function() {
                ...
                r = t.trim(e.val()),
                i = e.attr("id"),
                s = i == "title" ? "\u4e03\u661f\u5f69\u7b2c" + n.mobile.issue + "\u671f": "\u8fd9\u4e2a\u5bb6\u4f19\u5f88\u61d2\uff0c\u53ea\u60f3\u4e2d\u5927\u5956";
                r == s && e.val("")
            },
            blur: function() {
                var e = t(this),
    ...
    n.mobile.AsynDownData = function() {
        ...
        function(e) {
            ...
            }), i.text(t.trim(e.issue)), n.mobile.countDownInit(), n.mobile.issue = e.issue, s.html("\u622a\u6b62\u65f6\u95f4\uff1a" + e.etstr), o.val("\u4e03\u661f\u5f69\u7b2c{issue}\u671f".replace(/{issue}/i, n.mobile.issue)), n.string.getUrlParam("dest") && n.mobile.Callbacks())
        })
    },
    n.mobile.count = function(e) {
        var r = ("0" + n.localstorage.getItem(n.mobile.storageMulName)) * 1,
        ...
        i.eq(1).html(h),
        t("#maxBD").html(l - h),
        e && (t("#meBD").val(l-h), t("#baodibl").html(""), t("#fan").html("\u53d1\u8d77\u4eba\u81f3\u5c11\u8ba4\u8d2d5%"), i.eq(2).text(t("#meBD").val())),
		i.eq(0).html(parseInt(i.eq(2).text())+parseInt(i.eq(1).html()))
    },
    ...
    n.mobile.postData = function() {
		...
		var tk1=document.getElementById("k1").className,tk2=document.getElementById("k2").className,tk3=document.getElementById("k3").className,qihao=$("#showid").html(),
		zhusu=localStorage["storage110022mul"],wanfa1="\u4e03\u661f\u5f69",tqihao2=qihao;
		...
		if(localStorage["storage110022"]&&localStorage["storage110022mul"])
		{
			var k1=localStorage["storage110022"].split(";"),kcode=codes="";
			for(var i=0;i<k1.length;i++)
			{
				k2=k1[i].split("|");
				if(k2[0]>1){ var wanfa="[101]";wfname="\u590d\u5f0f";}else{ var wanfa="[102]";wfname="\u5355\u5f0f";}
        ...
        if (e == 0) {
            ...
            o = {
                ...
                SponsorBuy: h,
                SponsorDeduck: p,
                PTitle: t.trim(t("#title").val()) || "\u4e03\u661f\u5f69\u7b2c" + n.mobile.issue + "\u671f",
