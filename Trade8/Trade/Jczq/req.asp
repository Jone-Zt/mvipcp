...
Date.prototype.Format = function (fmt) { //author: meizz 
    ...
    return fmt;
                ...
                var buyInsert = {
                    ...
                    name:["UserName","BuyMemo","Play","Num","Mul","Total","tc","bd","hm","IsWin","State","overtime","type","SP","show","gdbs"],
                    value:[[Session('un'),o.e,o.c,o.a,o.d,Total-lostMoney,M.POST("tc"),into.BD,ishm,"0","0",overtimeorderid.Format("yyyy-MM-dd hh:mm:ss"),data.tp,SPPlan,Request.Form("show"),Request.Form("gdbs")]]
                }
                if(ishm=="1") {
