...
<script src="../JS/Qxc/cart.js"></script>
<script src="../JS/20141212.js"></script>
<script src="../JS/PassTime.js?v=0.0.1"></script>
</head><body>
<div class="head"><h2 id="navtit">投注七星彩</h2><a href="./index.asp" class="btn-qgkj" id="sourceUrl"><span><em></em></span>继续选号</a></div>
<div class="w320">
  <div class="area1">
    <div class="xq-tit" issue="2015091" issale="0" endtime="1438947900">
  ...
  <div class="area1">
    ...
    <div class="infolist none" id="k2">
      <table width="100%">
        ...
        <tr>
          <th>我要投注</th>
          <td><input type="tel" class="ipt-6" id="meRG" autocomplete="off" value="0" maxlength="7"><%=setting(56)%> <cite style="font-size:12px;">发起人至少投注5%</cite></td>
        </tr>
        <tr>
          <th>我要保底</th>
          <td><input type="tel" class="ipt-6" id="meBD" autocomplete="off" value="0" maxlength="7"><%=setting(56)%> <em id="baodibl"></em> <cite style="font-size:12px;">最多可保底<strong id="maxBD" class="red">1</strong><%=setting(56)%></cite></td>
        </tr>
        <tr>
          <th>是否公开</th>
        ...
        <tr>
            <th>方案标题</th>
            <td><input type="text" id="title" autocomplete="off" maxlength="30" class="ipt-c" value="七星彩第{issue}期"></td>
          </tr>
          <tr>
            <th>合玩宣言</th>
