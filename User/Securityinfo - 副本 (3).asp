	...
	<div class="login_list">
		<ul>
			...
			<li>
				...
				<div class="f_box bd_box">
					<em>用户头像</em>
					<input type="text" name="pic" id="pic" value="" class="txt color_black" style="width:300px;"/>
				</div>
			</li>
			<iframe src="http://www.588micai.com/Include/KR.Upload.asp?lei=2&pid=pic" frameborder="0" width="100%" height="25" scrolling="No"></iframe>
