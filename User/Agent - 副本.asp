...
<div>
    ...
    <form id="frm_search" onSubmit="javascript:Vip.SelectWhere(this);return false" style="margin-left:17px;">
        <div>
        	<span class="m_r10 l"><span  class="l">用户名：<input style="width:80px" class="basic_txt gray" name="username" type="text" id="username" placeholder="所有用户" autocomplete="off" /></span><span  class="l" id="IsTime" style="display:none"><span class="l">
                <select name="IsLt" id="LottID" style="margin-left:6px;font-size:16px;height:33px;vertical-align:-1px;" onChange="javascript:$('#frm_search').submit()">
             	...
             	<input name="sdate" class="basic_txt gray" type="text" id="sdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="<%=Format_Time(now()-7,2)%>" style="margin-left:7px;width:100px" /> - <input name="edate" class="basic_txt gray" type="text" id="edate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="<%=Format_Time(now(),2)%>" style="width:100px"/>
             </span></span>
    ...
    <div id="VipList" style="display:none;margin-top:50px">
		...
		<div id="VipUrl" style="display:none">
            ...
            <div class="s_level"><b class="e_mark"></b>温馨提示：点击复制就可以将代理网址发给你的用户进行推广了。</div>
            <div class="sec_m">
                <ul>
                    <li></li><%if Setting(15)="1" then%>
                    <li><span style="margin-left:180px;">代理链接：<A HREF="<%=Setting(2)%>/User/Reg/?u=<%=session("dldiy")%>" TARGET="_blank"><b id="DlUrl"><%=Setting(2)%>/User/Reg/?u=<%=session("dldiy")%></b></A> <a href="javascript:void(0);">[复制]</a></span></li><%else%>
                    <li><span style="margin-left:180px;">代理链接：<A HREF="http://<%=session("dldiy")%>.<%=DlUrl%>/" TARGET="_blank"><b id="DlUrl">http://<%=session("dldiy")%>.<%=DlUrl%>/</b></A> <a href="javascript:void(0);" onClick="javascript:Vip.Copy_DlUrl();">[复制]</a></span></li><%end if%>
                </ul>
            </div>
        </div>  
</div>
...
<div id="mesWindowTow" align="center"><div><div class="tips_box"><div class="tips_title"><h2></h2><span class="close"><a href="javascript:GdObj.CloSe('mesWindowTow');">关闭</a></span></div> 	
            <div class="filter_s">
            <span  class="l">用户名：<input style="width:100px" class="basic_txt gray" name="username" type="text" id="IsUserName" placeholder="所有用户" autocomplete="off" /></span>
