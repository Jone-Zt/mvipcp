var Pk10 = (function(ds){
	 ...
	 _pro_.InitWinMoney = function(){
		var me = this ; 
		if (!this.winSet["1001"]){
			ds.get("/Trade/Pk10/BuildWin.asp?act=get",function(data){
				me.winSet = data ;
			},'JSON')
		} 
	 } 
	 _pro_.InfoConfig = {
		"1011":"选号与开奖号码中第一位一致即中奖{$}",
	    "1021":"选号与开奖号码按位猜对1-2位即中奖2-{$}" ,
		"1022":"猜中开奖号码前两位且顺序一至即中奖{$}",
	    "1031":"猜每期开奖前3名，命中1-3位，奖金2-{$}",
	    "1032":"猜中开奖号码前三位且顺序一至即中奖{$}",
		"1041":"猜每期开奖前四名，命中1-4位，奖金2-{$}",
		"1042":"猜中开奖号码前四位且顺序一至即中奖{$}",
	    "1051":"猜每期开奖前五名，命中1-5位，奖金2-{$}",
		"1061":"猜每期开奖前六名，命中2-6位，奖金2-{$}",
	    "1071":"猜每期开奖前七名，命中2-7位，奖金2-{$}",
		"1081":"猜每期开奖前八名，命中2-8位，奖金2-{$}",
		"1091":"猜每期开奖前九名，命中2-9位，奖金2-{$}",
		"1001":"猜每期开奖前十名，命中0或10位，奖金2或{$}",
		"2053":"猜中开奖号码前五位中任意一位,即中奖{$}",
		"2054":"猜中开奖号码后五位中任意一位,即中奖{$}",
		"3051":"猜中开奖号码前五位中任意一位形态,即中奖{$}",
		"3052":"猜中开奖号码后五位中任意一位形态,即中奖{$}",
		"3053":"猜中前两位开奖号码和形态即中奖{$}",
	 }
