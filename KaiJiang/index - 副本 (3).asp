...
<div class="wrap">
  ...
  <div class="w320">
  	<div class="kj"><ul id="jczq"><a href="./jczq.asp"><li><h2>竞彩足球<span></span></h2><dl><dd><div class="jczqkj">
<%
set rsjczq=conn.execute("select top 1 * from KR_Football_Code order by left(OrderId,8) desc,right(OrderId,3)")
