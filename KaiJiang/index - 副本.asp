...
<div class="wrap">
  ...
  <div class="nav">
	<ul>
		<li><a href="../index.asp">投 注<div class="nav-arr"></div></a></li>
        <li><a href="/Trade/">合 玩<div class="nav-arr"></div></a></li>
		<li class="on"><a href="./index.asp">开 奖<div class="nav-arr"></div></a></li>
        <li><a href="/News/index.asp">资 讯<div class="nav-arr"></div></a></li>
	</ul>
</div>  <div class="w320">
    <div class="kj">
      	<ul id="mylottery"></ul>
...
<div id="sheader" style="position: fixed; top: 0px; left: 0px; width: 100%; transform: translate(0px, -135px); opacity: 1;"><a href="javascript:alert('1客户端，敬请期待...')"><div class="head-btn"></div></a></div>
